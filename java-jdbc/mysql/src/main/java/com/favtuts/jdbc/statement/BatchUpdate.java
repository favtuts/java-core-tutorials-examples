package com.favtuts.jdbc.statement;
...
public class BatchUpdate {
    ...
    public static void main(String[] args) {
        ...
        try (Connection conn = DriverManager.getConnection(
            ...
            // insert
            statement.addBatch(generateInsert("favtuts", new BigDecimal(1000)));

            // insert
            statement.addBatch(generateInsert("jane", new BigDecimal(2000)));

            // update
            statement.addBatch(updateSalaryByName("favtuts", new BigDecimal(888)));
