package com.favtuts.jdbc.statement.row;
...
public class RowInsert {
    ...
    public static void main(String[] args) {
        ...
        try (Connection conn = DriverManager.getConnection(
            ...
            System.out.println(generateInsert("favtuts", new BigDecimal(999.80)));

            int row = statement.executeUpdate(generateInsert("favtuts", new BigDecimal(999.80)));
